 ...
 */
var counter = 1;
var MapEditor = exports.MapEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function MapEditor(props) {
    ...
    _this.handleAddNode = _this.handleAddNode.bind(_assertThisInitialized(_this));
    _this.handleDeleteEdge = _this.handleDeleteEdge.bind(_assertThisInitialized(_this));
    _this.handleDeleteNode = _this.handleDeleteNode.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(MapEditor, [{
    ...
    value: function findNode(id) {
      var result;
      _underscore["default"].each(this.props.topology.nodes, function (node) {
        if (node.id === id) {
          result = node;
        }
      });
    ...
    value: function findEdge(id) {
      ...
      _underscore["default"].each(this.props.topology.edges, function (edge) {
        if ("".concat(edge.source, "--").concat(edge.target) === id) {
          result = edge;
        }
      });
      return result;
    ...
    value: function cloneTopo() {
      var topo = {
        ...
        nodes: _underscore["default"].map(this.props.topology.nodes, function (n) {
          return _underscore["default"].clone(n);
        }),
        edges: _underscore["default"].map(this.props.topology.edges, function (e) {
          return _underscore["default"].clone(e);
        })
      };
      return topo;
    }
    ...
    value: function handleNodeDrag(id, posx, posy) {
      ...
      var _this$constrain = this.constrain(posx, posy),
        x = _this$constrain.x,
        y = _this$constrain.y;
      _underscore["default"].each(topo.nodes, function (node) {
        if (node.id === id) {
          node.x = x;
          node.y = y;
        }
    ...
    value: function handleAddNodePosition(posx, posy) {
      var topo = this.cloneTopo();
      var _this$constrain2 = this.constrain(posx, posy),
        x = _this$constrain2.x,
        y = _this$constrain2.y;
      var n = {
        id: this.makeId(),
        label_dx: null,
        label_dy: null,
        label_position: "top",
        name: "untitled".concat(counter++),
        type: "node",
        x: x,
        y: y
      };
    ...
    value: function handleDeleteNodeSelection(nodeId) {
      ...
      if (action.nodes.length === 1) {
        ...
        var topo = this.cloneTopo();
        topo.nodes = _underscore["default"].filter(topo.nodes, function (n) {
          return n.id !== nodeId;
        });
        topo.edges = _underscore["default"].filter(topo.edges, function (e) {
    ...
    value: function renderNodeProperties() {
      ...
      nodeSpec.unshift({
        ...
        label: "Type",
        type: "choice",
        options: _underscore["default"].map(this.props.stylesMap, function (s, type) {
          return {
            value: type,
            label: type
          };
      ...
      if (this.state.selectionType === "node") {
        propertyElements = _underscore["default"].map(nodeSpec, function (property) {
          ...
          return /*#__PURE__*/_react["default"].createElement("tr", {
            ...
            width: 100
          }, property.label)), /*#__PURE__*/_react["default"].createElement("td", null, editorElement));
        });
      }
      return /*#__PURE__*/_react["default"].createElement("table", {
        width: "100%"
      }, /*#__PURE__*/_react["default"].createElement("tbody", null, propertyElements));
    }
  }, {
    ...
    value: function renderEdgeProperties() {
      ...
      var edgeSpec = [{
        ...
        label: "Capacity",
        type: "choice",
        options: _underscore["default"].map(this.props.edgeThicknessMap, function (e, k) {
          return {
            value: k,
            label: k
          };
      ...
      if (this.state.selectionType === "edge") {
        propertyElements = _underscore["default"].map(edgeSpec, function (property) {
          var v = selected[property.attr];
          var editorElement;
          switch (property.type) {
            case "text":
      ...
      if (this.state.selection) {
        if (this.state.selectionType === "node") {
          return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
            style: headerStyle
          }, this.state.selection.name), /*#__PURE__*/_react["default"].createElement("p", null), /*#__PURE__*/_react["default"].createElement("div", null, this.renderNodeProperties()));
        } else {
          var edge = this.state.selection;
          var title = "".concat(edge.source, " to ").concat(edge.target);
          return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
            style: headerStyle
          }, title), /*#__PURE__*/_react["default"].createElement("p", null), /*#__PURE__*/_react["default"].createElement("div", null, this.renderEdgeProperties()));
        }
      } else {
        return /*#__PURE__*/_react["default"].createElement("span", null, "Nothing selected");
      }
    }
  }, {
    key: "renderToolbar",
    value: function renderToolbar() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "glyphicon glyphicon-plus",
        "aria-hidden": "true"
      }), " Edge"), /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
        ...
        className: "glyphicon glyphicon-minus",
        "aria-hidden": "true"
      }), " Edge"), /*#__PURE__*/_react["default"].createElement("span", {
        style: {
          color: "steelblue",
          marginLeft: 10
        }
    ...
    value: function renderMap() {
      ...
      var mapSelection = {
        ...
        edges: this.state.selectionType === "edge" ? ["".concat(this.state.selection.source, "--").concat(this.state.selection.target)] : []
      };
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, this.renderToolbar())), /*#__PURE__*/_react["default"].createElement("div", {
        className: "row"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "col-md-12",
        style: {
        ...
        className: "col-md-9"
      }, this.renderMap()), /*#__PURE__*/_react["default"].createElement("div", {
        className: "col-md-3"
